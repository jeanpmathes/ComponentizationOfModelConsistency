...
public class GeneratedQueryModelExpressionTypeConfiguration implements QueryModelExpressionTypeConfiguration {
    @Override
    public void configure(@NonNull JvmGenericType queryModelExpressionType, @NonNull ViewTypeDefinition viewTypeDefinition) {
