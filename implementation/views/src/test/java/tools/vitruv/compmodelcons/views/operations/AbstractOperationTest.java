...
class AbstractOperationTest {
  ...
  protected static FeatureBinding createBinding(EObject originSubjectObject,
                                                EObject viewSubjectObject, ValueBinding value) {
  ...
  public enum Model {
    ...
    public URI getMetamodelURI() throws URISyntaxException {
      return URI.createFileURI(Paths
                                   .get(Objects
                                            .requireNonNull(getClass()
                                                                .getClassLoader()
                                                                .getResource(
                                                                    String.format("models/%s.ecore",
                                                                                  metamodel)))
                                            .toURI())
                                   .toString());
    }
    ...
    protected TestContext() {
      super(new OriginResourceAccess() {
        ...
        public Collection<Resource> getResources(EPackage ePackage) {
          ...
          return Streams
              .concat(Stream.of(models.getModel(model)), models
        ...
        @Override
        public Optional<URI> getViewUriHint(List<EPackage> originPackages,
                                            EPackage viewtypePackage) {
