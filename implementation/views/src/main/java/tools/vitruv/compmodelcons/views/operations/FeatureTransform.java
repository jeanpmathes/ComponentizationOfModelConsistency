...
public class FeatureTransform implements FeatureOriginOperation {
    ...
    private final Functions.Function5<EChange<EObject>, FeatureBinding, ObjectBinding, ValueUpdateBinding, PutContext, FeatureBinding>
            put;
    private final Functions.Function4<FeatureBinding, ObjectBinding, EChange<EObject>, GetContext, FeatureBinding>
            updatingGet;

    public FeatureTransform(Functions.Function2<ObjectBinding, GetContext, FeatureBinding> get, Functions.Function5<EChange<EObject>, FeatureBinding, ObjectBinding, ValueUpdateBinding, PutContext, FeatureBinding> put, Functions.Function4<FeatureBinding, ObjectBinding, EChange<EObject>, GetContext, FeatureBinding> updatingGet) {
        this.get = get;
        this.put = put;
    ...
    @Override
    public FeatureBinding doUpdatingGet(FeatureBinding previous, ObjectBinding subjectBinding, EChange<EObject> originChange, GetContext context) {
