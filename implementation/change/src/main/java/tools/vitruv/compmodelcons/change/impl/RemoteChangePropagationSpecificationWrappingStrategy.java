...
public class RemoteChangePropagationSpecificationWrappingStrategy
  ...
  public EditableCorrespondenceModelView<Correspondence> wrapCorrespondenceModel(
    ...
    return new RemoteEditableCorrespondenceModelViewImpl<>(correspondenceModel, context
        .sourceView()
  ...
  private static class RemoteCorrespondenceModelViewImpl<C extends Correspondence>
    ...
    private RemoteCorrespondenceModelViewImpl(CorrespondenceModelView<C> inner,
    ...
    public <V extends C> CorrespondenceModelView<V> getView(Class<V> correspondenceType) {
      return new RemoteCorrespondenceModelViewImpl<>(inner.getView(correspondenceType),
  ...
  private static class RemoteEditableCorrespondenceModelViewImpl<C extends Correspondence>
      extends RemoteCorrespondenceModelViewImpl<C> implements EditableCorrespondenceModelView<C> {
    private final EditableCorrespondenceModelView<C> editableInner;

    private RemoteEditableCorrespondenceModelViewImpl(EditableCorrespondenceModelView<C> inner,
                                                      CorrespondenceResolver sourceResolver,
                                                      CorrespondenceResolver targetResolver) {
    ...
    public <V extends C> EditableCorrespondenceModelView<V> getEditableView(
      ...
      return new RemoteEditableCorrespondenceModelViewImpl<>(
