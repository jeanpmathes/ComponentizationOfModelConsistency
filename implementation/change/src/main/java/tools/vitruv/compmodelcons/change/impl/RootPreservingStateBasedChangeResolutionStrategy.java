...
public class RootPreservingStateBasedChangeResolutionStrategy
  ...
  private static final class RootPreservingMatchEngineFactory extends MatchEngineFactoryImpl {
    ...
    public IMatchEngine getMatchEngine() {
      if (matchEngine == null) {
        ...
        IEObjectMatcher rootPreservingMatcher = new IdentifierEObjectMatcher(defaultMatcher,
                                                                             RootPreservingStateBasedChangeResolutionStrategy::getIdentifierForRootEObject);

        matchEngine = new DefaultMatchEngine(rootPreservingMatcher, new DefaultComparisonFactory(
